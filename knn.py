...
p1 = ax.scatter(data_train[:, 0], data_train[:, 1], c=category_train, s=25)
p1_ = ax.scatter(data_test[:, 0], data_test[:, 1], c=category_test, s=25)
plt.title('Data split into three categories')
ax.legend([p1, p1_], ['Categories'], scatterpoints=3)
plt.show()
